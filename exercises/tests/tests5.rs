...
unsafe fn modify_by_address(address: usize) {
    // SAFETY: The caller guarantees that the address is valid and points to a unique
    // mutable reference of a `u32` value. Dereferencing and modifying this value is safe
